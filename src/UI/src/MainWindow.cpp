...
void MainWindow::setupUi() {
    ...
    // Connections
    connect(m_commandBar, &CommandBar::commandSubmitted,
            this, &MainWindow::onCommandSubmitted);
    connect(m_sidebar, &Sidebar::fileOpened,
            this, &MainWindow::onFileOpenedFromSidebar);
    connect(m_tabWidget, &QTabWidget::tabCloseRequested,
            this, &MainWindow::onTabCloseRequested);
  connect(&Theme::ThemeEngine::instance(), &Theme::ThemeEngine::themeChanged,
...
EditorTab* MainWindow::createTab(Editor::Document* doc) {
    ...
    connect(tab, &EditorTab::diagnosticsReceived,
