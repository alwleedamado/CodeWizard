...
macro(CodeWizard_setup_options)
  ...
  if(NOT PROJECT_IS_TOP_LEVEL OR CodeWizard_PACKAGING_MAINTAINER_MODE)
    option(CodeWizard_ENABLE_IPO "Enable IPO/LTO" OFF)
    ...
    option(CodeWizard_ENABLE_SANITIZER_ADDRESS "Enable address sanitizer" OFF)
    option(CodeWizard_ENABLE_SANITIZER_LEAK "Enable leak sanitizer" OFF)
    option(CodeWizard_ENABLE_SANITIZER_UNDEFINED "Enable undefined sanitizer" OFF)
    ...
    option(CodeWizard_ENABLE_CACHE "Enable ccache" OFF)
  else()
    ...
    option(CodeWizard_ENABLE_SANITIZER_MEMORY "Enable memory sanitizer" OFF)
    option(CodeWizard_ENABLE_UNITY_BUILD "Enable unity builds" OFF)
    option(CodeWizard_ENABLE_CLANG_TIDY "Enable clang-tidy" ON)
    option(CodeWizard_ENABLE_CPPCHECK "Enable cpp-check analysis" ON)
    option(CodeWizard_ENABLE_PCH "Enable precompiled headers" OFF)
  ...
  if(NOT PROJECT_IS_TOP_LEVEL)
    mark_as_advanced(
      ...
      CodeWizard_ENABLE_UNITY_BUILD
      CodeWizard_ENABLE_CLANG_TIDY
      CodeWizard_ENABLE_CPPCHECK
      CodeWizard_ENABLE_COVERAGE
      CodeWizard_ENABLE_PCH
